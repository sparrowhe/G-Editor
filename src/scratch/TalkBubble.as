...
public class TalkBubble extends Sprite {
	...
	private static var resultFormat:TextFormat = new TextFormat(CSS.font, 14, /*CSS.textColor*/0x000000, true, null, null, null, null, TextFormatAlign.CENTER);
	private var outlineColor:int = /*0xA0A0A0*/0x4c97ff;
	...
	public function TalkBubble(s:String, type:String, style:String, source:Object) {
		...
		if (style == 'ask') {
			...
			outlineColor = /*0x888888*/0xacacac;
			minWidth = 16;
			padding = 3;
			radius = 5;
			pInset1 = 8;
