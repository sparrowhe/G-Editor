...
class SimpleTooltip {
	...
	private const bgColor:uint = /*0xfcfed4*/0xFFFFFF;
	...
	function SimpleTooltip() {
		...
		sprite.filters = [/*new DropShadowFilter(4, 90, 0, 0.6, 12, 12, 0.8)*/new GlowFilter(0x4c97ff, 1,4, 4, 10, 1,false, false)];
	...
	private function renderTooltip(text:String):void {
		...
		g.clear();
		g.lineStyle(1, /*0xCCCCCC*/0xffffff);
		g.beginFill(bgColor);
