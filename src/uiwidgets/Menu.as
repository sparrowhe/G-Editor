...
public class Menu extends Sprite {
	...
	public function Menu(clientFunction:Function = null, menuName:String = '', color:int = /*0xA0A0A0*/0x4c97ff, itemHeight:int = 28) {
	...
	/*	var f:DropShadowFilter = new DropShadowFilter();
		...
		f.distance = 0;//3
		f.color = 0x555555;*/
		var f:GlowFilter=new GlowFilter(0x000000, 0.2,3.2,3.2, 10, 1, true, false);
		filters = [f];
	}
