...
public class SpriteInfoPart extends UIPart implements DragClient {
	...
	private const readoutLabelFormat:TextFormat = new TextFormat(CSS.font, 12, /*0xA6A8AB*/CSS.textColor, true);
	private const readoutFormat:TextFormat = new TextFormat(CSS.font, 12, /*0xA6A8AB*/0x000000);
	...
	private function drawDirWheel(dir:Number):void {
		...
		g.endFill();
		g.lineStyle(2, /*0xD0D0D0*/0x7bb4ff, 1, true);
		g.drawCircle (0, 0, r - 3);

		// direction pointer
	 	g.lineStyle(3, 0x4c97ff/*0x006080*/, 1, true);
		g.moveTo(0, 0);
