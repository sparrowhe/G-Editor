...
public class SoundsPart extends UIPart {
	...
	private function addNewSoundButtons():void {
		var left:int = 16;//16
		var buttonY:int = 31;//31
		addChild(libraryButton = makeButton(soundFromLibrary, 'soundlibrary', left, buttonY+20000));//+20000等于隐藏按钮，素材库砍了
		addChild(recordButton = makeButton(recordSound, 'record', left+10 /*+ 34*/, buttonY));
		addChild(importButton = makeButton(soundFromComputer, 'import', left+40 /*+ 61*/, buttonY - 1));
	}
