...
public class Scratch extends Sprite {
	...
	protected function initialize():void {
		...
		stage.color = /*0x003355*//*0x101010*//*0xF1E6FF*/0xFFFFFF;

		stage.align = StageAlign.TOP_LEFT;
		stage.scaleMode = StageScaleMode.NO_SCALE;
		stage.frameRate = 32;//30//fps修改

		Block.setFonts(12, 10, false, 0); // default font sizes//模块字体大小//10,9,true,0//14
		...
		setEditMode(true);
		//runtime.startInProjectFile('file:///I:/Dump/Downloads/2015/FlatWar.sb2');

		 //comment out for pre-loaded project
...
/*
		...
		txt.background = false;           // Enables to display the background colors
		txt.borderColor = 0x007800;      // Sets the border color
		txt.border = false;               // Enables to display the border
		txt.text = "poop";     // Adds text
...
//		}
	...
	protected function updateLayout(w:int, h:int):void {
		topBarPart.x = 0;
		topBarPart.y = 0;
		topBarPart.setWidthHeight(w, /*28*/32);
	...
	protected function addFileMenuItems(b:*, m:Menu):void {
		...
		m.addLine();
		m.addItem('关于G-Editor',doscrisgeoabout,true);
		m.addItem('访问G-Editor官网',Visitorsnetwork,true);
	...
	public function doscrisgeoabout()
	{
		DialogBox.notify("关于","G-Editor，做最好用的Scratch编辑器。版本："+versionString);
		/*		var _Newurl:URLRequest=new URLRequest("http://p.ble.ac.cn/ge/");
		var _fangshi:String="_blank";
		navigateToURL(_Newurl,_fangshi);*/
	}
	
	public function Visitorsnetwork()
	{
		var _Newurl:URLRequest=new URLRequest("http://p.ble.ac.cn/ge/");
		var _fangshi:String="_blank";
		navigateToURL(_Newurl,_fangshi);
