...
public class Specs {
	...
	public static var procedureColor:int = 0xff6680;//0x673ab7; // 0x531E99;
	...
	/*	[0,  "undefined",	0xD42828],
		...
		[2,  "Looks",		0x009587],
		[3,  "Sound",		0x3e50b4],
		[4,  "Pen",			0x607d8b], // Scratch 1.4: 0x009870
		[5,  "Events",		0xfec006],
		[6,  "Control",		0x8ac249],
		[7,  "Sensing",		0x00bbd3],
		[8,  "Operators",	0x4bae4f],
		...
		[9,  "Data",		variableColor],
		[10, "More Blocks",	procedureColor/*0xff6680*/],
		[11, "Parameter",	parameterColor/*0xff4d6b*/],
		[12, "List",		listColor],
		[13, "增强",		0x00ccff],
		[14, "蓝柠云服务",		0x2683f5],
		[20, "Extension",	extensionsColor],
	...
	public static var commands:Array = [
		...
		["*移动 %n 步 向 %m.spriteOrMouse",						" ", 1, "move:toward:",					10, "鼠标"],
		["*移动 %n 步 向 ( x:%n , y:%n )",						" ", 1, "move:towardX:Y:",					10, 0, 0],
		["*移动 %n 步 向 %n 度",						" ", 1, "move:at:",					15],
		["--"],
		["turn @turnRight %n degrees",			" ", 1, "turnRight:",				15],
		["turn @turnLeft %n degrees",			" ", 1, "turnLeft:",				15],
		["point in direction %d.direction",		" ", 1, "heading:",					90],
		["point towards %m.spriteOrMouse",		" ", 1, "pointTowards:",			"鼠标"],
		["*面向 x:%n y:%n",						" ", 1, "turnx:y:",					0,0],
		["--"],
		["*以 %m.spriteOrMouse 为中心旋转 %n 度",	" ", 1, "orbitSprite:by:", "鼠标", 15],
		["*以 ( x:%n , y:%n ) 为中心旋转 %n 度",			" ", 1, "orbitX:Y:by:", 0, 0, 15],
		["*以 %m.spriteOrMouse 为中心旋转 %n 步",		" ", 1, "orbitSprite:for:", "鼠标", 10],
		["*以 ( x:%n , y:%n ) 为中心旋转 %n 步",			" ", 1, "orbitX:Y:for:", 0, 0, 10],
		["--"],
		["go to x:%n y:%n",						" ", 1, "gotoX:y:"],
		["移到 %m.spriteOrMouse",				" ", 1, "gotoSpriteOrMouse:",		"鼠标"],
		...
		["--"],
		["*可以拖拽吗？",							"b", 1, "getDrag"],
		["*设为可以拖拽",						" ", 1, "setDragTrue"],
		["*设为不可以拖拽",					" ", 1, "setDragFalse"],
		...
		["-"],
		["*是显示的吗？", 								"b", 2, "shown"],
		["*%m.spriteOnly 的克隆体编号为 %n 的克隆体是显示的吗？"	,	"b", 2, "cloneOf:no:visible"],
		["show",								" ", 2, "show"],
		["hide",								" ", 2, "hide"],
		["-"],
		...
		["change %m.effect effect by %n",		" ", 2, "changeGraphicEffect:by:",	"ghost", 25],
		["set %m.effect effect to %n",			" ", 2, "setGraphicEffect:to:",		"ghost", 0],
		...
		["-"],
		["change %m.effect effect by %n",		" ", 102, "changeGraphicEffect:by:",	/*"color"*/ "ghost", 25],
		["set %m.effect effect to %n",			" ", 102, "setGraphicEffect:to:",		/*"color"*/ "ghost", 0],
		...
		["*当作为克隆体启动且序号为 %n",			"h", 6, "whenClonedAs:", 1],
		["*当我的克隆体序号在序号 %n 到 %n 之间的情况下启动时",		"h", 6, "whenClonedFrom:to:", 1, 2],
		["create clone of %m.spriteOnly",		" ", 6, "createCloneOf"],
		["*克隆 %m.spriteOnly 当作 %s",	" ", 6, "createCloneOf:as:"],
		...
		["create clone of %m.spriteOnly as %s",	" ", 106, "createCloneOf:as:"],
		["reset clones",						" ", 106, "resetClones"],
		...
		["-"],
		["%m.attribute of %m.spriteOnly",	"r", 7, "getAttribute:of:"],
		["%m.attribute of %m.spriteOnly clone # %n",	"r", 7, "getAttr:of:no:", "x position", "_myself_" , 1],
		["*是克隆体吗?",								"b", 7, "isClone"],
		["-"],
		...
		["-"],
//		["%s",								    "b", 8, "isTrue", "true"],
//		["%m.trueandfalse",						"r", 8, "isture:",		"true"],
//		["%m.trueandfalse",							"b", 8, "isture:",		"true"],
		["*%m.char",							"b", 8, "character:",		"true"],
		["%s < %s",								"b", 8, "<",					"", ""],
		["%s = %s",								"b", 8, "=",					"", ""],
		["%s > %s",								"b", 8, ">",					"", ""],
		["*%s ≤ %s",								"b", 8, "≤",					"", ""],
		...
		["-"],
		["*%s",									"r", 8, "aName:",	""],
		["join %s %s",							"r", 8, "concatenate:with:",	"你好", "世界"],
		["letter %n of %s",						"r", 8, "letter:of:",			1, "文本"],
		["length of %s",						"r", 8, "stringLength:",		"文本"],
		["-"],
		["*%m.case %s",						"r", 8, "case:on:",		"大写"],
//		["%m.char",							"r", 8, "character:",		"♣"],
		["-"],
		["%n mod %n",							"r", 8, "%",					"", ""],
		["round %n",							"r", 8, "rounded", 				""],
		["-"],
		...
		["repeat for %m.var from %n to %n by %n",			"c", 9, "repeatFor:from:to:by:", "", 1, 5, 1],
		["-"],
